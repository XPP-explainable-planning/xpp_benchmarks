(define (problem transport-l6-t2-p7---int100n150-m5---int100c200---s51---e0)
...
p0 p1 p2 p3 p4 p5 p6 - package
    level20 level19 level18 level17 level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - fuellevel
)
