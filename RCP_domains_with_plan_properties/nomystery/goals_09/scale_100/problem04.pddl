(define (problem transport-l6-t2-p9---int100n150-m5---int100c100---s45---e0)
...
level0 level1 level2 level3 level4 level5 level6 level7 level8 level9 level10 level11 level12 level13 level14 level15 - fuellevel
)
