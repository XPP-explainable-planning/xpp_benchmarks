...
soft-LTL_property achive_image_data_objective0_before_rock_data_waypoint13
U ! communicated_rock_data(waypoint13) communicated_image_data(objective0,colour)
