...
soft-LTL_property achive_soil_data_waypoint11_before_rock_data_waypoint1
U ! communicated_rock_data(waypoint1) communicated_soil_data(waypoint11)
...
soft-LTL_property achive_rock_data_waypoint1_before_rock_data_waypoint3
U ! communicated_rock_data(waypoint3) communicated_rock_data(waypoint1)


soft-LTL_property achive_image_data_objective0_before_rock_data_waypoint3
U ! communicated_rock_data(waypoint3) communicated_image_data(objective0,high_res)
