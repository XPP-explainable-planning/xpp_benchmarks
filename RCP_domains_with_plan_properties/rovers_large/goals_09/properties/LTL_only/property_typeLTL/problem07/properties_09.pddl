...
U ! communicated_image_data(objective3,low_res) communicated_soil_data(waypoint4)
...
soft-LTL_property achive_soil_data_waypoint4_before_rock_data_waypoint10
U ! communicated_rock_data(waypoint10) communicated_soil_data(waypoint4)


soft-LTL_property achive_rock_data_waypoint11_before_rock_data_waypoint7
U ! communicated_rock_data(waypoint7) communicated_rock_data(waypoint11)


soft-LTL_property achive_rock_data_waypoint10_before_rock_data_waypoint11
U ! communicated_rock_data(waypoint11) communicated_rock_data(waypoint10)


soft-LTL_property achive_image_data_objective3_before_rock_data_waypoint11
U ! communicated_rock_data(waypoint11) communicated_image_data(objective3,low_res)
