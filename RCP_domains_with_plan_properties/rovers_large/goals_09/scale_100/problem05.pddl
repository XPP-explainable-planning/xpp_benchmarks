(define (problem roverprob--s47--m5--r2--w15--o4--c2--g9--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level4 waypoint3 waypoint12)
	(energycost level4 waypoint12 waypoint3)
	...
	(energycost level5 waypoint5 waypoint6)
	(energycost level5 waypoint6 waypoint5)
	...
	(energycost level3 waypoint8 waypoint10)
	(energycost level3 waypoint10 waypoint8)
	...
	(energycost level4 waypoint11 waypoint14)
	(energycost level4 waypoint14 waypoint11)
