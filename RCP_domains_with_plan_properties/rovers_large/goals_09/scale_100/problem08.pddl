(define (problem roverprob--s51--m5--r2--w15--o4--c2--g9--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level4 waypoint1 waypoint6)
	(energycost level4 waypoint6 waypoint1)
	...
	(energycost level2 waypoint3 waypoint13)
	(energycost level2 waypoint13 waypoint3)
	(energycost level5 waypoint3 waypoint14)
	(energycost level5 waypoint14 waypoint3)
	(energycost level1 waypoint4 waypoint10)
	(energycost level1 waypoint10 waypoint4)
	...
	(energycost level3 waypoint7 waypoint13)
	(energycost level3 waypoint13 waypoint7)
	...
	(energycost level3 waypoint9 waypoint10)
	(energycost level3 waypoint10 waypoint9)
	...
	(energycost level3 waypoint12 waypoint14)
	(energycost level3 waypoint14 waypoint12)
