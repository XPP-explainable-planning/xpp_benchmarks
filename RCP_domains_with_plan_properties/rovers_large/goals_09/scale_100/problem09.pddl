(define (problem roverprob--s52--m5--r2--w15--o4--c2--g9--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level4 waypoint1 waypoint12)
	(energycost level4 waypoint12 waypoint1)
	...
	(energycost level1 waypoint4 waypoint14)
	(energycost level1 waypoint14 waypoint4)
	...
	(energycost level1 waypoint6 waypoint12)
	(energycost level1 waypoint12 waypoint6)
