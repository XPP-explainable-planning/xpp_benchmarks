(define (problem roverprob--s45--m5--r2--w15--o4--c2--g9--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
	...
	level0 level1 level2 level3 level4 level5 level6 level7 level8 level9 level10 level11 level12 - energylevel
	)
(:init
	...
	(energycost level2 waypoint0 waypoint12)
	(energycost level2 waypoint12 waypoint0)
	...
	(energycost level2 waypoint3 waypoint5)
	(energycost level2 waypoint5 waypoint3)
	...
	(energycost level4 waypoint6 waypoint12)
	(energycost level4 waypoint12 waypoint6)
