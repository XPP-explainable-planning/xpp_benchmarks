(define (problem roverprob--s54--m5--r2--w15--o4--c2--g9--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level4 waypoint1 waypoint8)
	(energycost level4 waypoint8 waypoint1)
	...
	(energycost level1 waypoint3 waypoint9)
	(energycost level1 waypoint9 waypoint3)
	...
	(energycost level3 waypoint5 waypoint6)
	(energycost level3 waypoint6 waypoint5)
	...
	(energycost level1 waypoint6 waypoint11)
	(energycost level1 waypoint11 waypoint6)
	(energycost level3 waypoint6 waypoint13)
	(energycost level3 waypoint13 waypoint6)
	(energycost level1 waypoint7 waypoint8)
	(energycost level1 waypoint8 waypoint7)
	...
	(energycost level5 waypoint10 waypoint11)
	(energycost level5 waypoint11 waypoint10)
	(energycost level3 waypoint10 waypoint12)
	(energycost level3 waypoint12 waypoint10)
