(define (problem roverprob--s46--m5--r2--w15--o4--c2--g7--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level4 waypoint0 waypoint7)
	(energycost level4 waypoint7 waypoint0)
	...
	(energycost level4 waypoint1 waypoint5)
	(energycost level4 waypoint5 waypoint1)
	...
	(energycost level2 waypoint3 waypoint7)
	(energycost level2 waypoint7 waypoint3)
	(energycost level5 waypoint3 waypoint9)
	(energycost level5 waypoint9 waypoint3)
	...
	(energycost level4 waypoint10 waypoint13)
	(energycost level4 waypoint13 waypoint10)
	(energycost level3 waypoint11 waypoint12)
	(energycost level3 waypoint12 waypoint11)
