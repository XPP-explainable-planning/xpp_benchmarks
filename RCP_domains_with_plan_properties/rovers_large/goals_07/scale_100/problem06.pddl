(define (problem roverprob--s61--m5--r2--w15--o4--c2--g7--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level3 waypoint7 waypoint11)
	(energycost level3 waypoint11 waypoint7)
	(energycost level4 waypoint7 waypoint12)
	(energycost level4 waypoint12 waypoint7)
