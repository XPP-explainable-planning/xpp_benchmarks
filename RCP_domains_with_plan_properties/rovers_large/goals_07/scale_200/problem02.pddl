(define (problem roverprob--s53--m5--r2--w6--o3--c2--g7--p1--P2--c20) (:domain Rover)
(:objects
	general - Lander
    ...
    level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - energylevel
	)
(:init
