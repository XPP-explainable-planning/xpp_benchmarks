...
soft-LTL_property achive_soil_data_waypoint8_before_image_data_objective1
U ! communicated_image_data(objective1,low_res) communicated_soil_data(waypoint8)
