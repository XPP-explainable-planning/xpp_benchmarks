...
soft-LTL_property achive_soil_data_waypoint14_before_image_data_objective2
U ! communicated_image_data(objective2,colour) communicated_soil_data(waypoint14)
