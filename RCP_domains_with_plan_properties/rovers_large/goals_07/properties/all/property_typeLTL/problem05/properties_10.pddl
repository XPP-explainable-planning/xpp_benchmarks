...
U ! communicated_image_data(objective2,low_res) communicated_soil_data(waypoint6)


soft-LTL_property achive_rock_data_waypoint9_before_rock_data_waypoint1
U ! communicated_rock_data(waypoint1) communicated_rock_data(waypoint9)
