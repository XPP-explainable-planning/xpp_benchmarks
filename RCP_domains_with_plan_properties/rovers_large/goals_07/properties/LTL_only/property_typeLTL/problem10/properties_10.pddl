...
soft-LTL_property achive_image_data_objective1_before_image_data_objective2
U ! communicated_image_data(objective2,colour) communicated_image_data(objective1,low_res)
