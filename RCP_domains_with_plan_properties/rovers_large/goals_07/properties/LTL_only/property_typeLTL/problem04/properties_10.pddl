...
soft-LTL_property achive_image_data_objective3_before_rock_data_waypoint0
U ! communicated_rock_data(waypoint0) communicated_image_data(objective3,low_res)
