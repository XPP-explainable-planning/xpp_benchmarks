...
soft-LTL_property achive_soil_data_waypoint14_before_rock_data_waypoint1
U ! communicated_rock_data(waypoint1) communicated_soil_data(waypoint14)


soft-LTL_property achive_image_data_objective3_before_rock_data_waypoint13
U ! communicated_rock_data(waypoint13) communicated_image_data(objective3,colour)


soft-LTL_property achive_rock_data_waypoint1_before_image_data_objective3
U ! communicated_image_data(objective3,colour) communicated_rock_data(waypoint1)


soft-LTL_property achive_image_data_objective0_before_image_data_objective3
U ! communicated_image_data(objective3,colour) communicated_image_data(objective0,low_res)
