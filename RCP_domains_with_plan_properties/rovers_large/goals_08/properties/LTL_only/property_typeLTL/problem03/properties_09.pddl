...
soft-LTL_property achive_rock_data_waypoint0_before_image_data_objective3
U ! communicated_image_data(objective3,low_res) communicated_rock_data(waypoint0)


soft-LTL_property achive_image_data_objective3_before_image_data_objective3
U ! communicated_image_data(objective3,low_res) communicated_image_data(objective3,colour)
