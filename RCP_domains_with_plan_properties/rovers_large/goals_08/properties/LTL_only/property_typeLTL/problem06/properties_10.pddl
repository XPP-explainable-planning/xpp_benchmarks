...
soft-LTL_property achive_soil_data_waypoint1_before_rock_data_waypoint3
U ! communicated_rock_data(waypoint3) communicated_soil_data(waypoint1)


soft-LTL_property achive_rock_data_waypoint13_before_rock_data_waypoint3
U ! communicated_rock_data(waypoint3) communicated_rock_data(waypoint13)
...
soft-LTL_property achive_soil_data_waypoint1_before_soil_data_waypoint9
U ! communicated_soil_data(waypoint9) communicated_soil_data(waypoint1)
