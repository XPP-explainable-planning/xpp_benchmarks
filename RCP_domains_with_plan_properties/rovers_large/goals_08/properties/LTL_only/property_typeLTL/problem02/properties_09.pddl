...
soft-LTL_property achive_rock_data_waypoint2_before_image_data_objective3
U ! communicated_image_data(objective3,high_res) communicated_rock_data(waypoint2)


soft-LTL_property achive_image_data_objective3_before_image_data_objective3
U ! communicated_image_data(objective3,high_res) communicated_image_data(objective3,low_res)
