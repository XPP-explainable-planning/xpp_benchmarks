...
soft-LTL_property achive_rock_data_waypoint7_before_image_data_objective0
U ! communicated_image_data(objective0,colour) communicated_rock_data(waypoint7)


soft-LTL_property achive_image_data_objective2_before_image_data_objective0
U ! communicated_image_data(objective0,colour) communicated_image_data(objective2,high_res)
