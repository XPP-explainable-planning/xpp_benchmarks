(define (problem roverprob--s57--m5--r2--w15--o4--c2--g8--p2--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level5 waypoint0 waypoint7)
	(energycost level5 waypoint7 waypoint0)
	(energycost level4 waypoint0 waypoint10)
	(energycost level4 waypoint10 waypoint0)
	(energycost level3 waypoint0 waypoint11)
	(energycost level3 waypoint11 waypoint0)
	(energycost level4 waypoint0 waypoint12)
	(energycost level4 waypoint12 waypoint0)
	(energycost level5 waypoint0 waypoint13)
	(energycost level5 waypoint13 waypoint0)
	...
	(energycost level5 waypoint1 waypoint7)
	(energycost level5 waypoint7 waypoint1)
	(energycost level3 waypoint1 waypoint9)
	(energycost level3 waypoint9 waypoint1)
	(energycost level4 waypoint1 waypoint10)
	(energycost level4 waypoint10 waypoint1)
	...
	(energycost level4 waypoint2 waypoint7)
	(energycost level4 waypoint7 waypoint2)
	(energycost level3 waypoint2 waypoint8)
	(energycost level3 waypoint8 waypoint2)
	(energycost level3 waypoint2 waypoint12)
	(energycost level3 waypoint12 waypoint2)
	...
	(energycost level4 waypoint4 waypoint7)
	(energycost level4 waypoint7 waypoint4)
	(energycost level4 waypoint4 waypoint10)
	(energycost level4 waypoint10 waypoint4)
	(energycost level2 waypoint4 waypoint11)
	(energycost level2 waypoint11 waypoint4)
	(energycost level2 waypoint5 waypoint7)
	(energycost level2 waypoint7 waypoint5)
	(energycost level4 waypoint5 waypoint8)
	(energycost level4 waypoint8 waypoint5)
	(energycost level1 waypoint5 waypoint9)
	(energycost level1 waypoint9 waypoint5)
	(energycost level3 waypoint5 waypoint11)
	(energycost level3 waypoint11 waypoint5)
	(energycost level5 waypoint5 waypoint13)
	(energycost level5 waypoint13 waypoint5)
	...
	(energycost level1 waypoint6 waypoint14)
	(energycost level1 waypoint14 waypoint6)
	...
	(energycost level3 waypoint7 waypoint14)
	(energycost level3 waypoint14 waypoint7)
	(energycost level5 waypoint8 waypoint9)
	(energycost level5 waypoint9 waypoint8)
	...
	(energycost level2 waypoint9 waypoint10)
	(energycost level2 waypoint10 waypoint9)
	(energycost level4 waypoint9 waypoint12)
	(energycost level4 waypoint12 waypoint9)
	(energycost level1 waypoint9 waypoint13)
	(energycost level1 waypoint13 waypoint9)
	...
	(energycost level5 waypoint10 waypoint14)
	(energycost level5 waypoint14 waypoint10)
	(energycost level5 waypoint11 waypoint13)
	(energycost level5 waypoint13 waypoint11)
	...
	(energycost level2 waypoint13 waypoint14)
	(energycost level2 waypoint14 waypoint13)
