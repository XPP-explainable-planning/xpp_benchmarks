(define (problem roverprob--s46--m5--r2--w15--o4--c2--g8--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level1 waypoint0 waypoint9)
	(energycost level1 waypoint9 waypoint0)
	(energycost level3 waypoint0 waypoint11)
	(energycost level3 waypoint11 waypoint0)
	(energycost level1 waypoint0 waypoint13)
	(energycost level1 waypoint13 waypoint0)
	...
	(energycost level4 waypoint2 waypoint5)
	(energycost level4 waypoint5 waypoint2)
	...
	(energycost level2 waypoint2 waypoint12)
	(energycost level2 waypoint12 waypoint2)
	...
	(energycost level5 waypoint4 waypoint10)
	(energycost level5 waypoint10 waypoint4)
	(energycost level3 waypoint4 waypoint11)
	(energycost level3 waypoint11 waypoint4)
	(energycost level5 waypoint4 waypoint14)
	(energycost level5 waypoint14 waypoint4)
	(energycost level5 waypoint5 waypoint11)
	(energycost level5 waypoint11 waypoint5)
