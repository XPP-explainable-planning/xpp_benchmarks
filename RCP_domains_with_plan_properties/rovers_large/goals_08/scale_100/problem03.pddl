(define (problem roverprob--s45--m5--r2--w15--o4--c2--g8--p2--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level4 waypoint0 waypoint6)
	(energycost level4 waypoint6 waypoint0)
	...
	(energycost level2 waypoint0 waypoint10)
	(energycost level2 waypoint10 waypoint0)
	(energycost level3 waypoint0 waypoint12)
	(energycost level3 waypoint12 waypoint0)
	(energycost level3 waypoint0 waypoint13)
	(energycost level3 waypoint13 waypoint0)
	...
	(energycost level2 waypoint1 waypoint10)
	(energycost level2 waypoint10 waypoint1)
	...
	(energycost level4 waypoint2 waypoint9)
	(energycost level4 waypoint9 waypoint2)
	(energycost level2 waypoint2 waypoint10)
	(energycost level2 waypoint10 waypoint2)
	(energycost level4 waypoint2 waypoint11)
	(energycost level4 waypoint11 waypoint2)
	(energycost level5 waypoint2 waypoint12)
	(energycost level5 waypoint12 waypoint2)
	(energycost level5 waypoint2 waypoint14)
	(energycost level5 waypoint14 waypoint2)
	(energycost level2 waypoint3 waypoint4)
	(energycost level2 waypoint4 waypoint3)
	(energycost level1 waypoint3 waypoint5)
	(energycost level1 waypoint5 waypoint3)
	(energycost level1 waypoint3 waypoint7)
	(energycost level1 waypoint7 waypoint3)
	(energycost level5 waypoint3 waypoint8)
	(energycost level5 waypoint8 waypoint3)
	(energycost level2 waypoint3 waypoint11)
	(energycost level2 waypoint11 waypoint3)
	(energycost level5 waypoint3 waypoint12)
	(energycost level5 waypoint12 waypoint3)
	(energycost level1 waypoint3 waypoint14)
	(energycost level1 waypoint14 waypoint3)
	...
	(energycost level3 waypoint4 waypoint10)
	(energycost level3 waypoint10 waypoint4)
	(energycost level5 waypoint4 waypoint11)
	(energycost level5 waypoint11 waypoint4)
	...
	(energycost level4 waypoint6 waypoint10)
	(energycost level4 waypoint10 waypoint6)
	...
	(energycost level3 waypoint7 waypoint9)
	(energycost level3 waypoint9 waypoint7)
	(energycost level4 waypoint7 waypoint10)
	(energycost level4 waypoint10 waypoint7)
	(energycost level4 waypoint7 waypoint14)
	(energycost level4 waypoint14 waypoint7)
	...
	(energycost level5 waypoint8 waypoint13)
	(energycost level5 waypoint13 waypoint8)
	...
	(energycost level1 waypoint10 waypoint13)
	(energycost level1 waypoint13 waypoint10)
	(energycost level1 waypoint11 waypoint12)
	(energycost level1 waypoint12 waypoint11)
	(energycost level4 waypoint13 waypoint14)
	(energycost level4 waypoint14 waypoint13)
