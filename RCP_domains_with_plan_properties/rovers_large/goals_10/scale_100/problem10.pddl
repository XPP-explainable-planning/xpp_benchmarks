(define (problem roverprob--s52--m5--r2--w15--o4--c2--g10--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level1 waypoint0 waypoint14)
	(energycost level1 waypoint14 waypoint0)
	(energycost level5 waypoint1 waypoint2)
	(energycost level5 waypoint2 waypoint1)
	...
	(energycost level5 waypoint1 waypoint14)
	(energycost level5 waypoint14 waypoint1)
	...
	(energycost level4 waypoint2 waypoint6)
	(energycost level4 waypoint6 waypoint2)
	...
	(energycost level4 waypoint2 waypoint14)
	(energycost level4 waypoint14 waypoint2)
	(energycost level4 waypoint3 waypoint5)
	(energycost level4 waypoint5 waypoint3)
	(energycost level1 waypoint3 waypoint6)
	(energycost level1 waypoint6 waypoint3)
	...
	(energycost level4 waypoint5 waypoint6)
	(energycost level4 waypoint6 waypoint5)
	...
	(energycost level2 waypoint5 waypoint14)
	(energycost level2 waypoint14 waypoint5)
	...
	(energycost level5 waypoint6 waypoint10)
	(energycost level5 waypoint10 waypoint6)
	...
	(energycost level5 waypoint7 waypoint11)
	(energycost level5 waypoint11 waypoint7)
	...
	(energycost level2 waypoint8 waypoint11)
	(energycost level2 waypoint11 waypoint8)
	...
	(energycost level1 waypoint11 waypoint13)
	(energycost level1 waypoint13 waypoint11)
	...
	(energycost level5 waypoint12 waypoint14)
	(energycost level5 waypoint14 waypoint12)
