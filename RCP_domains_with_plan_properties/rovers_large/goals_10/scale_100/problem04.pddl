(define (problem roverprob--s45--m5--r2--w15--o4--c2--g10--p2--P2--C10) (:domain Rover)
(:objects
	general - Lander
	...
	level0 level1 level2 level3 level4 level5 level6 level7 level8 level9 level10 level11 level12 level13 - energylevel
	)
(:init
	...
	(energycost level4 waypoint0 waypoint13)
	(energycost level4 waypoint13 waypoint0)
	...
	(energycost level5 waypoint1 waypoint11)
	(energycost level5 waypoint11 waypoint1)
	...
	(energycost level5 waypoint3 waypoint14)
	(energycost level5 waypoint14 waypoint3)
	...
	(energycost level1 waypoint10 waypoint12)
	(energycost level1 waypoint12 waypoint10)
