(define (problem roverprob--s51--m5--r2--w15--o4--c2--g10--p2--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level5 waypoint2 waypoint8)
	(energycost level5 waypoint8 waypoint2)
	...
	(energycost level3 waypoint2 waypoint13)
	(energycost level3 waypoint13 waypoint2)
	...
	(energycost level2 waypoint3 waypoint14)
	(energycost level2 waypoint14 waypoint3)
	...
	(energycost level4 waypoint4 waypoint12)
	(energycost level4 waypoint12 waypoint4)
	(energycost level2 waypoint4 waypoint13)
	(energycost level2 waypoint13 waypoint4)
	...
	(energycost level2 waypoint5 waypoint11)
	(energycost level2 waypoint11 waypoint5)
