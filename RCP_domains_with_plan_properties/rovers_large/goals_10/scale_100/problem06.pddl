(define (problem roverprob--s48--m5--r2--w15--o4--c2--g10--p1--P2--C10) (:domain Rover)
(:objects
	general - Lander
...
(:init
	...
	(energycost level3 waypoint1 waypoint14)
	(energycost level3 waypoint14 waypoint1)
	...
	(energycost level3 waypoint2 waypoint9)
	(energycost level3 waypoint9 waypoint2)
	...
	(energycost level2 waypoint4 waypoint14)
	(energycost level2 waypoint14 waypoint4)
	...
	(energycost level4 waypoint6 waypoint14)
	(energycost level4 waypoint14 waypoint6)
	(energycost level2 waypoint7 waypoint8)
	(energycost level2 waypoint8 waypoint7)
	(energycost level5 waypoint7 waypoint10)
	(energycost level5 waypoint10 waypoint7)
	...
	(energycost level4 waypoint8 waypoint13)
	(energycost level4 waypoint13 waypoint8)
	...
	(energycost level1 waypoint9 waypoint12)
	(energycost level1 waypoint12 waypoint9)
	(energycost level4 waypoint9 waypoint14)
	(energycost level4 waypoint14 waypoint9)
	(energycost level3 waypoint10 waypoint11)
	(energycost level3 waypoint11 waypoint10)
