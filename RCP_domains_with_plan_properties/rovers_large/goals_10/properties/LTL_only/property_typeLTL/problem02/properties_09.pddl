...
soft-LTL_property achive_rock_data_waypoint4_before_image_data_objective3
U ! communicated_image_data(objective3,high_res) communicated_rock_data(waypoint4)


soft-LTL_property achive_image_data_objective0_before_image_data_objective3
U ! communicated_image_data(objective3,high_res) communicated_image_data(objective0,colour)
