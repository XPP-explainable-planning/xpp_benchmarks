...
soft-LTL_property not_holding_together_b3_b4
[] ! || && holding(b3,h0) holding(b4,h1) && holding(b4,h0) holding(b3,h1) 


soft-LTL_property on_the_table_at the_same_time_b6_b3
<>  && ontable(b6) ontable(b3) 
