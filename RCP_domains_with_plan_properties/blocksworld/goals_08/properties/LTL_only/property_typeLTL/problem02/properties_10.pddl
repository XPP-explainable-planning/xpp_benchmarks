...
U !  ||  ||  ||  ||  ||  ||  || holding(b0,h1) holding(b1,h1) holding(b2,h1) holding(b3,h1) holding(b4,h1) holding(b5,h1) holding(b6,h1) holding(b7,h1)   ||  ||  ||  ||  ||  ||  || holding(b0,h0) holding(b1,h0) holding(b2,h0) holding(b3,h0) holding(b4,h0) holding(b5,h0) holding(b6,h0) holding(b7,h0) 


soft-LTL_property on_the_table_at the_same_time_b5_b6
<>  && ontable(b5) ontable(b6) 
...
state_set use_hand1-t1 4
stack block block h1 energylevel energylevel energylevel
unstack block block h1 energylevel energylevel energylevel
pick-up block h1 energylevel energylevel energylevel
put-down block h1 energylevel energylevel energylevel

soft-LTL_property use_hand1_at_most_once
! <> && use_hand1-t1 X <> use_hand1-t1
