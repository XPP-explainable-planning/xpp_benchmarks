...
U ! communicated_soil_data(waypoint2) communicated_image_data(objective2,colour)


soft-LTL_property take_image_objectiveobjective2_before_rock_data_atwaypoint1
U ! communicated_rock_data(waypoint1) communicated_image_data(objective2,colour)
