(define (problem roverprob--s51--m5--r2--w5--o3--c4--g9--p1--P2--c30) (:domain Rover)
(:objects
	general - Lander
    ...
    level33 level32 level31 level30 level29 level28 level27 level26 level25 level24 level23 level22 level21 level20 level19 level18 level17 level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - energylevel
	)
(:init
