...
soft-LTL_property take_image_objectiveobjective0_before_rock_data_atwaypoint3
U ! communicated_rock_data(waypoint3) communicated_image_data(objective0,colour)
