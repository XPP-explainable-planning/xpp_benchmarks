(define (problem roverprob--s50--m5--r2--w5--o3--c4--g6--p1--P2--c12) (:domain Rover)
(:objects
	general - Lander
    ...
    level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - energylevel
	)
(:init
