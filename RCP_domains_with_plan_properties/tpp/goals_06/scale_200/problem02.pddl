(define (problem tpp-problem-m5-g6-c200nc0)
...
(:objects
    ...
    level26 level25 level24 level23 level22 level21 level20 level19 level18 level17 level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - moneylevel
)
(:init
...
(sum level26 level0 level26)
	...
	(drive-cost market1 depot0 level4)
	(connected market1 depot0)
	(drive-cost market1 market0 level5)
	...
	(at truck0 depot0)
(money truck0 level26)
	(at truck1 depot0)
(money truck1 level26)
)
(:goal (and
	(stored goods0)
	(stored goods1)
