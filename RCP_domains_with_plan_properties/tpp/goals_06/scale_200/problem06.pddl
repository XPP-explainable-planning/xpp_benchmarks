...
(:objects
    ...
    level30 level29 level28 level27 level26 level25 level24 level23 level22 level21 level20 level19 level18 level17 level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - moneylevel
)
(:init
...
(sum level30 level0 level30)
	...
	(at truck0 depot0)
(money truck0 level30)
	(at truck1 depot0)
(money truck1 level28)
)
(:goal (and
	(stored goods0)
	(stored goods1)
