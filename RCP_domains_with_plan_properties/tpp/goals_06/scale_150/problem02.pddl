(define (problem tpp-problem-m5-g6-c150nc0)
...
(:objects
    ...
    level19 level18 level17 level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - moneylevel
)
(:init
...
(sum level19 level0 level19)
	...
	(at truck0 depot0)
(money truck0 level19)
	(at truck1 depot0)
(money truck1 level19)
)
(:goal (and
	(stored goods0)
	(stored goods1)
